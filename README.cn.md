...
[![x-cmd/install — eightctl Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/eightctl.svg?lang=zh)](https://x-cmd.com/install/eightctl)
...
合计: **8,667** 行代码（覆盖前 5 种语言、共 **93** 个文件）。
...
- **上游仓库**: <https://github.com/steipete/eightctl>
- **官网**: <https://eightctl.sh>
- **许可证**: MIT

## 发布

- **最新版本**: `v0.2.8` (2026-09-22)
- **最近提交**: 2026-09-22
- **Release 含资产**: 11 个

## 流行度

- **Star**: 99 · **Fork**: 30 · **开放 issue**: 15 · **贡献者**: 6

## 累计统计

- **发布数**: 9 · **已合并 PR**: 82 · **开放 PR**: 0 · **已关闭 issue**: 14 · **开放 issue**: 1 · **提交数**: 121

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-27 | 5 | 40 | 0 | 0 | 1 | 41 |
| last60d | 2026-07-28 | 7 | 50 | 0 | 0 | 1 | 50 |
| 90d | 2026-06-28 | 9 | 71 | 0 | 1 | 1 | 74 |
| last180d | 2026-03-30 | 9 | 78 | 0 | 1 | 1 | 92 |
| 360d | 2025-10-01 | 9 | 82 | 0 | 14 | 1 | 121 |
| last720d | 2024-10-06 | 9 | 82 | 0 | 14 | 1 | 121 |
...
eightctl 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `eightctl` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/eightctl.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T05:39:02Z._
